...
app.get("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id); // da string a int
...
app.post("/jokes", (req, res) => {
  ...
  jokes.push(newJoke);
  console.log(jokes.slice(-1)); //fa vedere l'ultimo joke dell'array
  res.json(newJoke);
});
...
app.patch("/jokes/:id", (req, res) => {
  ...
  const replacementJoke = {
    id: id,
    jokesText: req.body.text || existingJoke.jokeText, // se la patch include anche il testo nuovo altrimenti lascia il testo che già c'è
...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (searchIndex > -1) {
    // se esiste
    jokes.splice(searchIndex, 1); // prende il searchIndex (esempio elemento con id 3) e rimuove un elemento dall'array
    res.sendStatus(200);
  } else {
    res
      .status(404)
